...
vi.mock("@/lib/store/use-flow-store", () => ({
    useFlowStore: (selector: any) => selector({
        selectedNode: null,
...
describe("Workflow IO Nodes", () => {
    describe("WorkflowInputNode", () => {
        ...
        it("should render correctly", () => {
            render(<WorkflowInputNode id="1" data={mockData} selected={false} type="workflow-input" zIndex={0} isConnectable={true} />);
    ...
    describe("WorkflowOutputNode", () => {
        ...
        it("should render correctly", () => {
            render(<WorkflowOutputNode id="2" data={mockData} selected={false} type="workflow-output" zIndex={0} isConnectable={true} />);
