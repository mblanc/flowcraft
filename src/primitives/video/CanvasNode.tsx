            ...
            <CanvasNodeContextMenu nodeId={id} onStartRename={startRename}>
                ...
                >
                    ...
                    <div className="border-border/50 bg-muted/20 relative h-full w-full overflow-hidden rounded-[24px] border shadow-sm">
                        {isPending && (
                            <div className="flex h-full flex-col items-center justify-center gap-2 bg-white/50">
                        ...
                        >
                            ...
                            {d.prompt && (
                                <div className="flex flex-col gap-1.5">
                                    <div className="nowheel text-foreground/90 custom-scrollbar max-h-[160px] overflow-y-auto border-l-[3px] border-purple-500/50 pl-3 text-sm leading-relaxed whitespace-pre-wrap">
                                        {d.prompt}
                                    </div>
                                    <Button
                                        variant="ghost"
